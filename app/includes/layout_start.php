...
if (hasPermission('stock_requests', 'view')) $navItems['stock_requests.php'] = 'Stock Requests';
...
$navIcons = [
    ...
    'stock_requests.php' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5 shrink-0"><path fill-rule="evenodd" d="M1 5.75A.75.75 0 011.75 5h1.5a.75.75 0 010 1.5H2.66l.5 4.505A2.75 2.75 0 005.891 13.5H15.5a.75.75 0 010 1.5H5.89a4.25 4.25 0 01-4.222-3.78L1.129 5.856a.75.75 0 01-.129-.106zM6 8.5A.5.5 0 016.5 8h6a.5.5 0 010 1h-6a.5.5 0 01-.5-.5zM6 11a.5.5 0 01.5-.5h4a.5.5 0 010 1h-4a.5.5 0 01-.5-.5zm-1 6a1.5 1.5 0 100 3 1.5 1.5 0 000-3zm9 0a1.5 1.5 0 100 3 1.5 1.5 0 000-3z" clip-rule="evenodd"/></svg>',
