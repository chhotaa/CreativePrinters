...
?>
    <div class="bg-white rounded-xl shadow-sm ring-1 ring-slate-200 p-5 mb-5">
        <input type="text" placeholder="Search restock orders..." oninput="filterTable(this, 'userRestockTable')" class="w-full sm:w-64 mb-3 px-3 py-2 border border-slate-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-brand-green focus:border-brand-green">
